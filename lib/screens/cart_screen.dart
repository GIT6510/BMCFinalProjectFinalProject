                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text('₱${cart.subtotal.toStringAsFixed(2)}', style: TextStyle(fontSize: 16, color: Colors.black)),
                    ],
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text('₱${cart.vat.toStringAsFixed(2)}', style: TextStyle(fontSize: 16, color: Colors.black)),
                    ],
                  ),
